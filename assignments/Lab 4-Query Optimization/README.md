...
**Assigned: Mon, May 18th**<br>
**Due: Thu, May 28th, 23:59 PM**
...
* Make a copy of your Lab 3 solution by typing:

```console
$ cp -r acmdb-lab3 acmdb-lab4
```
...
* Download the new tests and skeleton code for Lab 4 from [acmdb-lab4-supplement.tar.gz](assets/acmdb-lab4-supplement.tar.gz). (You can also find this file on Canvas.) Then place it in the acmdb-lab4 folder.

* Extract the new files for Lab 4 by typing:

```console
$ tar -xvzf acmdb-lab4-supplement.tar.gz
```

By the way, you should also make minor changes on azure-pipelines.yml (change `acmdb-lab3` to `acmdb-lab4`).
...
The optimizer will be invoked from <tt>simpledb/Parser.java</tt>.  Briefly, if you have a catalog file
...
<p align="center">
<img width=400 src="assets/controlflow.png"><br>
...
every access to a table incurs the full cost of a scan). Therefore, `scancost(t1)` is simply the
...
<p align="center">
<img width=400 src="assets/lab4-hist.png"><br>
...
<tt>IntHistogramTest</tt> unit test.
...
fancy for this, though it is possible to
include a histogram-based method for join selectivity estimation.
...
To submit your code, please create a `acmdb-lab4` directory in your github repo. Please submit your writeup as a PDF or plain text file (.txt) in the top level of your `acmdb-lab4` directory. Please do not submit a .doc or .docx.
