 ...
 * <p>
 * Change the value of the DEBUG_LEVEL constant using a system property: simpledb.Debug. For example, on the command
 * line, use -Dsimpledb.Debug=x, or simply -Dsimpledb.Debug to enable it at level 0. The log(level, message, ...) method
 * will print to standard output if the level number is less than or equal to the currently set DEBUG_LEVEL.
 */
