...
public class BTreePageId implements PageId {
    ...
    private static String categToString(int categ) {
        switch (categ) {
            case ROOT_PTR:
                return "ROOT_PTR";
            case INTERNAL:
    ...
    /**
     * @return a hash code for this page, represented by the concatenation of the table number, page number, and pgcateg
