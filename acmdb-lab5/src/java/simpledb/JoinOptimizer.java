...
public class JoinOptimizer {
    ...
    private final Vector<LogicalJoinNode> joins;
     ...
     * here -- because DbIterator's don't provide any cardinality estimates, and stats only has information about the
     ...
     */
    static DbIterator instantiateJoin(LogicalJoinNode lj, DbIterator plan1, DbIterator plan2)
    ...
    static int estimateTableJoinCardinality(Predicate.Op joinOp, String table1Alias, String table2Alias,
     ...
     */
    int estimateJoinCardinality(LogicalJoinNode j, int card1, int card2, boolean t1pkey, boolean t2pkey,
    ...
    /**
     * Helper method to enumerate all of the subsets of a given size of a specified vector. A faster implementation
     * using bit operation.
     *
     ...
     */
    Vector<LogicalJoinNode> orderJoins(HashMap<String, TableStats> stats, HashMap<String, Double> filterSelectivities,
                                       boolean explain)
    throws ParsingException {
        ...
        for (int i = 1; i <= size; ++i) {
            ...
            for (Set<LogicalJoinNode> s : subsets) {
                ...
                for (LogicalJoinNode sp : s) {
                    CostCard subplan = computeCostAndCardOfSubplan(stats, filterSelectivities, sp, s, bestCostSoFar,
                                                                   planCache);
                    if (subplan == null) {
                        continue;
                    }
