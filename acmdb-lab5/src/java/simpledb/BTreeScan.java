...
public class BTreeScan implements DbIterator {
     ...
     * @param ipred The index predicate to match. If null, the scan will return all tuples in sorted order
     */
    ...
    /**
     * Returns the TupleDesc with field names from the underlying BTreeFile, prefixed with the tableAlias string from
     * the constructor. This prefix becomes useful when joining tables containing a field(s) with the same name.
     *
     * @return the TupleDesc with field names from the underlying BTreeFile, prefixed with the tableAlias string from
     *         the constructor.
     */
