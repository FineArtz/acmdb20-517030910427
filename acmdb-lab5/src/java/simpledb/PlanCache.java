...
public class PlanCache {
    private final HashMap<Set<LogicalJoinNode>, Vector<LogicalJoinNode>> bestOrders = new HashMap<>();
    private final HashMap<Set<LogicalJoinNode>, Double> bestCosts = new HashMap<>();
    private final HashMap<Set<LogicalJoinNode>, Integer> bestCardinalities = new HashMap<>();
